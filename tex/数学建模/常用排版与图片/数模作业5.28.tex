...
\begin{document}
	...
	\vspace{0.3cm}
	\noindent
	\(\because \displaystyle \frac{dN}{N\left(1-\frac{N}{K}\right)} = r\,dt\)
	...
	\begin{enumerate}
		\item \textbf{Malthus模型}假设人口按指数增长，增长率\(r\)恒定。该模型形式简单，在人口增长早期或短期内拟合效果较好（两国\(R^2\)均大于0.98）。但其无法反映人口增长放缓的趋势，长期预测会严重偏离实际。
		
		\item \textbf{Logistic阻滞增长模型}考虑了资源环境对人口增长的限制，引入了环境容纳量\(K\)。该模型更符合人口增长的"S"型曲线特征：
		\begin{itemize}
