...
\begin{document}
	...
	\paragraph{题目}设 $\mathbb{R}^n$ 上的实值函数列 $\{f_n\}_{n\in\mathbb{N}_+}$ 满足 $\lim\limits_{n\to\infty}f_n(x)=f(x)$。证明对任意 $\alpha\in\mathbb{R}$，
	\[
	\left\{x\in\mathbb{R}^n:f(x)>\alpha\right\}
	=
	\bigcup_{k=1}^{\infty}\bigcup_{N=1}^{\infty}
	\bigcap_{n=N}^{\infty}
	\left\{x\in\mathbb{R}^n:f_n(x)\ge \alpha+\frac1k\right\}.
	\]
	
	\paragraph{答案}若 $x\in\left\{x\in\mathbb{R}^n:f(x)>\alpha\right\}$，即 $f(x)>\alpha$。
	取 $k\in\mathbb{N}_+$ 使得
	\[
	f(x)>\alpha+\frac1k.
	\]
	由 $f_n(x)\to f(x)\ (n\to\infty)$，存在 $N\in\mathbb{N}_+$，当 $n\ge N$ 时，有
	\[
	f_n(x)\ge\alpha+\frac1k.
	\]
	故
	\[
	x\in\bigcap_{n=N}^{\infty}\left\{x\in\mathbb{R}^n:f_n(x)\ge \alpha+\frac1k\right\},
	\]
	从而
	\[
	x\in\bigcup_{k=1}^{\infty}\bigcup_{N=1}^{\infty}\bigcap_{n=N}^{\infty}\left\{x\in\mathbb{R}^n:f_n(x)\ge \alpha+\frac1k\right\}.
	\]
	
	% 右边包含于左边
	若 $x\in\bigcup_{k=1}^{\infty}\bigcup_{N=1}^{\infty}\bigcap_{n=N}^{\infty}\left\{x\in\mathbb{R}^n:f_n(x)\ge \alpha+\frac1k\right\}$，
	则存在 $k,N\in\mathbb{N}_+$，使得对所有 $n\ge N$，
	\[
	f_n(x)\ge\alpha+\frac1k.
	\]
	令 $n\to\infty$，得
	\[
	f(x)=\lim_{n\to\infty}f_n(x)\ge\alpha+\frac1k>\alpha.
	\]
	故 $x\in\left\{x\in\mathbb{R}^n:f(x)>\alpha\right\}$。
	...
	\subsubsection*{题30（5.27作业P118例3）}
	...
	\subsubsection*{题31（《实变函数论》p119 思考题6）}
	...
	\subsubsection*{题32（《实变函数论》p126 习题2）}
	...
	\subsubsection*{题33（《实变函数论》p126 习题6）}
	\paragraph{题目}设 $\{f_k(x)\}$ 是 $E\subset\R^n$ 上的实值可测函数列，$\meas(E)<+\infty$。证明 $f_k(x)\to0$ a.e. 的充分必要条件是：对任意 $d>0$，有
	\[
	\lim_{j\to\infty}\meas\left(\left\{x\in E:\sup_{k\ge j}|f_k(x)|\ge d\right\}\right)=0.
	\]
	
	\paragraph{答案}记
	\[
	A_j(d)=\left\{x\in E:\sup_{k\ge j}|f_k(x)|\ge d\right\}.
	\]
	则 $A_j(d)$ 随 $j$ 递减，并且
	\[
	\bigcap_{j=1}^{\infty}A_j(d)=\left\{x\in E:\limsup_{k\to\infty}|f_k(x)|\ge d\right\}.
	\]
	由于 $\meas(E)<+\infty$，由测度的上连续性，
	\[
	\lim_{j\to\infty}\meas(A_j(d))
	=
	\meas\left(\bigcap_{j=1}^{\infty}A_j(d)\right).
	\]
	...
	\subsubsection*{题34（《实变函数论》p127 习题10）}
	...
	\subsubsection*{题35（《实变函数论》p127 习题14）}
	\paragraph{题目}设有定义在可测集 $E\subset\R^n$ 上的函数 $f(x)$，且对任给的 $\delta>0$，存在 $E$ 中的闭集 $F$，$\meas(E\setminus F)<\delta$，使得 $f(x)$ 在 $F$ 上连续。证明 $f(x)$ 是 $E$ 上的可测函数。
	...
	\subsubsection*{题36（《实变函数论》p127 习题15）}
	...
	\subsubsection*{题37（《实变函数论》p127 习题16）}
