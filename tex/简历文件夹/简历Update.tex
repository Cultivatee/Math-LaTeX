...
\begin{document}
	...
	\begin{itemize}
		...
		\item \textbf{主修课程}：概率论（91）、常微分方程（91）、教育学（89）、现代教育技术（94）、Python（96）\ 等。
		\item \textbf{担任职务}：\textbf{乐育书院团委组织部干事}（整理学生团籍资料，审核实践报销材料，担任入团考试、表彰大会场务 等）、乒乓球社团副社长、\textbf{班级宣传委员}（发表推文十余篇）、全媒体宣传中心文字采编部干事
		\item \textbf{所获荣誉}：\textbf{京师二等奖学金}，\textbf{学业二等奖学金}
%		\item \textbf{英语水平}：CET6成绩507分
	...
	\begin{itemize}
	\item 获班级第一、多次超越奖，\textbf{总分年级前20}%，高考616
	\end{itemize}
...
%	\textbf{教育实习}
	\begin{itemize}
		\item \textbf{贵州省沿河土家族自治县第二高级中学} \hfill 2026年6月 - 2026年7月 \\
		...
		针对西藏教育资源薄弱问题，负责五年级数学线上教学。讲授\textbf{20节课程}，形成《彩云之桥志愿者记录》及《学生成长手册》。学生期末平均分\textbf{提升15分}，家长评价：“课程设计好，善于看出孩子的不足。”
	...
	\section{\makebox[\widthof{\faGraduationCap}][c]{\color{WHU_Blue}{\faTrophy}}\quad 获奖情况}
		...
		\textbf{北京高校数学建模校际联赛一等奖} \hfill 2026年6月\newline
		...
		\textbf{北京师范大学乐育书院“绿竹”教师技能大比武二等奖} \hfill 2026年6月%7日
		\begin{itemize}
		...
		\textbf{北京师范大学乐育书院“绿竹”班主任技能大比武二等奖} \hfill 2025年12月%7日
		\begin{itemize}
		...
		\textbf{北京师范大学第四届师范生文化节\textbf{板书设计大赛二等奖}、\textbf{最美三笔字评比三等奖}}\hfill 2026年6月
%		\begin{itemize}
